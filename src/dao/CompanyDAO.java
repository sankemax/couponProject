...
public interface CompanyDAO {
	...
	/**
	 * This method is invoked by company facade method <code>login(String compName, String password)</code> to check whether 
	 * such login parameters exist in the system. In case they do, the method returns <code><b>true</b></code>; 
