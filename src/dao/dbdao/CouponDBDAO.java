...
public class CouponDBDAO implements CouponDAO {
	...
	public void createCoupon(long CompanyId, Coupon coupon) throws CouponSystemException {
		...
		try {
			...
			if (generatedInfo.next()) coupon.setCouponId(generatedInfo.getLong(1));
	...
	public List<Coupon> getCouponsCompanyByDate(long companyId, Date date) throws CouponSystemException {
		...
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		String sql = "SELECT id, title, start_date, end_date, amount, coupon_type, message, price, image FROM coupon c INNER JOIN company_coupon cc ON c.id = cc.coupon_id WHERE cc.comp_id = ? AND c.end_date <= ?";
		List<Coupon> couponList = null;
